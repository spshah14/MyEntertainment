...
const Reality = (props) => {
    ...
    const fetchData = async () => {
        ...
        const url = `https://api.themoviedb.org/3/discover/tv?api_key=${props.apikey}&language=hi-IN&sort_by=popularity.desc&with_type=3&page=5&with_origin_country=IN&include_video=true&append_to_response=videos,images&page=${page}`
    ...
    const fetchMoreData = async () => {
        // setPage(page + 1)
        const url = `https://api.themoviedb.org/3/discover/tv?api_key=${props.apikey}&language=hi-IN&sort_by=popularity.desc&with_type=3&page=5&with_origin_country=IN&include_video=true&append_to_response=videos,images&page=${page + 1}`
    ...
    return (
        <>
            ...
            <div className='container my-2'>
                <div className="container my-3 text-center" style={{ color: "rgb(238 238 238)" }}><h3>Reality Shows</h3></div>
